...
while running:
    ...
    cursor_x = 10 + font.size(text[:cursor_index])[0]
    cursor_y = 10 + cursor_ln*FONT_SIZE

    # Draw the cursor
    pygame.draw.rect(screen, (255, 255, 255), (cursor_x, cursor_y, 2, FONT_SIZE - 7))
...
while running:
    ...
    # Render and display the text
    for i in code:
        text_surface = font.render(f"{i}   {str(code[i])}", True, (255, 255, 255))
    ...
    # Draw the cursor
    pygame.draw.rect(screen, (255, 255, 255), (cursor_x + FONT_SIZE*4*0.235, cursor_y, 2, FONT_SIZE - 7))
